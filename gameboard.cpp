...
*
* Description:
*   Defines a class representing the gameboard.
*
* Notes:
*   This class is kept the same as in the given source code. No
...
Point GameBoard::food() const
{
    return food_;
}

const std::deque<Point> &GameBoard::snake() const
{
    return snake_;
}
