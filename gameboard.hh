...
####################################################################
* Description:
*   Declares a class representing the gameboard.
*
* Notes:
*   This file is kept as close to original file as possible. Only
* change is that getters were used to get snake deque and food point
* from the private section to public section
*/
...
public:
    ...
    // setters and getters
    const std::deque<Point> &snake() const;
